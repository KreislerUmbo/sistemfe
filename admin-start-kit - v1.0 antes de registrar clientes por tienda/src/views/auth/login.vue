      ...
      <b-card no-body>
        ...
        <b-card-body class="pt-0">
          <b-form class="my-4" @submit.prevent="handleLogin">
            <b-form-group class="mb-2" label="Usuario" label-for="username">
              <b-form-input type="text" placeholder="Ingrese su usuario" id="username" v-model="v.email.$model" />
            ...
            <div class="form-group row mt-3">
              <b-col sm="6">
                <div class="form-switch-success">
                  <b-form-checkbox switch>Recordar me</b-form-checkbox>
                </div>
              </b-col>
              <b-col sm="6" class="text-end">
                <router-link to="/auth/reset-pass" class="text-muted font-13"><i class="dripicons-lock"></i> Has
                  olvidado tu contraseña?</router-link>
              </b-col>
            </div>
