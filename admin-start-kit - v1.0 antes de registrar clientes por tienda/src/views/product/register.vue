                    ...
                    <b-tab title="General" active>
                        <b-row class="mt-3">
                            ...
                            <b-col lg="4" md="4">
                                ...
                                <b-form-input id="sku-product" type="text" v-model="sku"
                                    @input="sku = $event.target.value.toUpperCase()" placeholder="Example: FE4RFF" />
                            </b-col>
                        ...
                        <b-row class="mt-3">
                            <b-col lg="3" md="3">
                                ...
                                <b-form-input id="price_general" type="number" v-model="price_general"
                                    placeholder="150" />
                            </b-col>

                            <b-col lg="3" md="3">
                                <label for="price_company">Precio Cliente Empresa:</label>
                                <b-form-input id="price_company" type="number" v-model="price_company"
                                    placeholder="250" />
                            </b-col>
