...
const agregar = async () => {
    ...
    try {
        ...
        if (props.itemExistente) {
            ...
            const res = await alternativaItemService.agregarPasajeAereo(props.alternativaId, { ...payload, alternativa_destino_id: props.alternativaDestinoId ?? null });
