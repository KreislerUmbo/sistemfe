<template>
    <DefaultLayout>
        ...
        <b-card class="p-0">
            ...
            <RegisterLayout title="Modificar Producto" @save="store" @cancel="goToList" />
                    ...
                    <b-tab title="General" active>
                        ...
                        <b-row class="mt-3">
                            <b-col lg="3" md="3">
                                ...
                                <b-form-input type="number" v-model="price_general" placeholder="150" />
                            </b-col>

                            <b-col lg="3" md="3">
                                <label>Precio Cliente Empresa:</label>
                                <b-form-input type="number" v-model="price_company" placeholder="250" />
                            </b-col>

                            <b-col lg="5" md="5">
                                <label>Descripción:</label>
                                <b-form-textarea rows="5" v-model="description" />
                            </b-col>
                        </b-row>
                        ...
                        <b-row class="mt-3">
                            ...
                            <b-col lg="3" md="3">
                                <label>Stock:</label>
                                <b-form-input type="number" v-model="stock" placeholder="5" />
                            </b-col>
