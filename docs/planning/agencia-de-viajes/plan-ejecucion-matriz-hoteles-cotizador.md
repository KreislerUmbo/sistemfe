...
> **Estado: COMPLETO (02-sep-2026) — M1-M5 cerradas, mergeadas y
> pusheadas a `origin/main`.** Este documento queda como referencia de
> lo construido; ver la sección 2 para el detalle de cada sesión.
...
| Fecha | Cambio |
|---|---|
| 02-sep-2026 | **M5 cerrada — bloque M1-M5 COMPLETO.** Ver fila M5 de la tabla arriba para el detalle completo. Última sesión del plan; 3 bugs reales encontrados generando el PDF real contra `agencia-demo` (orden de columnas con `0` tratado como falsy, glifo unicode sin soporte en DomPDF, duplicado entre "Incluye" y la tabla nueva), todos corregidos y verificados con el PDF real (no solo tests). |
